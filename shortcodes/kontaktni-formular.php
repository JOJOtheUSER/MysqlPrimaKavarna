...
if (array_key_exists("odeslat", $_POST))
{
	...
	$formularOdeslan = true; // kvuli js pak
	$jmeno = $_POST["jmeno"];
	...
	{
		$chyby["zprava"] = "Zprava musí být zadána";
	}
	...
	if (count($chyby) == 0)
	{
		...
		$mail->isHTML(true);
		$mail->Subject = 'Kontaktni formulář PrimaKavárna';
		$mail->Body = "
			<h1>Kontaktní fomrulář PrimaKavárna</h1>
...
<div class="obsah" id="kontaktni-formular">
	<div class="container">
		...
		<div class="formular">
			...
			{
				echo "<h1>Kontaktni formulář byl úspěšně odeslán</h1>";
			}
			?>
